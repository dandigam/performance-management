...
public class PasswordResetController {
    ...
    public ResponseEntity<Map<String, String>> rateLimited(com.rit.performance.exception.PasswordResetRateLimitException e) {
        return ResponseEntity.status(429).header("Retry-After", "3600")
                .body(Map.of("message", e.getMessage()));
    }
    @ExceptionHandler(InvalidOperationException.class)
    public ResponseEntity<Map<String, String>> invalid(InvalidOperationException e) {
